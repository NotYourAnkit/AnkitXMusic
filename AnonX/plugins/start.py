...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEB1K1j32CZc-y3ooqq6H_tBg2-ytVzFQACOAcAAtCL-FYkIovExJW4hi4E)
        ...
        if name == "verify":
            await message.reply_text(f"ʜᴇʏ {message.from_user.first_name},\n𝙏𝙝𝙖𝙣𝙠𝙨 𝙁𝙤𝙧 𝙑𝙚𝙧𝙞𝙛𝙮𝙞𝙣𝙜 𝙔𝙤𝙪𝙧𝙎𝙚𝙡𝙛 𝙄𝙉 {config.MUSIC_BOT_NAME}, 𝙉𝙤𝙬 𝙔𝙤𝙪 𝘾𝙖𝙣 𝙂𝙤 𝘽𝙖𝙘𝙠 𝘼𝙣𝙙 𝙎𝙩𝙖𝙧𝙩 𝙐𝙨𝙞𝙣𝙜 𝙈𝙚 🥰.")
            if await is_on_off(config.LOG):
                sender_id = message.from_user.id
                sender_name = message.from_user.first_name
                return await app.send_message(
...
🎥 **ᴄʜᴀɴɴᴇʟ:** {channel}
📎 **𝙎𝙪𝙥𝙥𝙤𝙧𝙩:** [𝙃𝘼𝙒𝘼 𝙃𝘼𝙒𝘼𝙄](https://t.me/HawaHawai_xD)
⚠️ **𝗢𝘄𝗻𝗲𝗿:** [𝗔𝗻𝗸𝗶𝘁⚠️](https://t.me/NotYourAnkit) 
